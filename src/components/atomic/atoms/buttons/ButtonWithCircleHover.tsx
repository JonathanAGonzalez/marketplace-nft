...
export const ButtonWithCircleHover = ({ text }: ButtonWithHoverProps) => {
  return (
    <button className='relative border hover:border-blue-600 duration-500 group cursor-pointer text-sky-50  overflow-hidden h-14 w-56 rounded-md bg-blue-800 p-2 flex justify-center items-center font-extrabold'>
